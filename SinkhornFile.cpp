...
// [[Rcpp::export()]]
Rcpp::List SinkhornDistance(arma::mat a, arma::mat b, arma::mat costMatrix, double lambda = 1, int maxIter = 10000000, double tolerance = 0.00000001) {
  
  
  // Transforming Input
  arma::mat K = exp(-(1/lambda)*costMatrix);
  ...
  arma::mat Distance = sum(u % (U * v)) ; //compute Sinkhorn Distance
